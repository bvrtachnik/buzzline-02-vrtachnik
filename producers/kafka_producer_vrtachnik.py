...
def generate_messages(producer, topic, interval_secs):
    ...
    """
    string_list: list = [
        "Trying to get this Kafka thing working...",
        "Not totally sure what I'm doing, but here goes.",
        "Is this how you're supposed to send messages?",
        "Still learning, so this might break.",
        "If you're reading this, it probably worked!",
    ]
    try:
        while True:
